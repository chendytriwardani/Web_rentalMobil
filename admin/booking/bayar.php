<?php
    ...
    $hsl = $koneksi->query("CALL get_bayar('$id_booking')")->fetch();
    $c = $koneksi->query("CALL get_bayar('$id_booking')")->rowCount();
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control" name="pengembalian">
                                    <option <?php if($hasil['pengembalian'] == 'ya'){echo 'selected';}?>>
                                        ya
                                    </option>
                                    <option <?php if($hasil['pengembalian'] == 'tidak'){echo 'selected';}?>>
                                        tidak
                                    </option>
                                </select>    
                            </td>
